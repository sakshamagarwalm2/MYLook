...
const ProjectHome = () => {
  return (
    <div className="bg-light w-full h-full bg-grid-small-black/[0.2] rounded-t-3xl text-black border-b-8 border-b-stone-300 mt-0 lg:mt-28 flex justify-center items-center flex-col">
