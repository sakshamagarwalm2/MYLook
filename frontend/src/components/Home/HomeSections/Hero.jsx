...
const Hero = () => {
  return (
    <section
      className="w-full h-auto md:h-screen text-center orbitron-100 bg-cover bg-center text-white text-2xl -z-30 shadow-inner"
    ...
    >
      ...
      <div className="w-full md:h-screen md:pt-4 overflow-hidden">
        <div className="w-full h-auto  bg-stone-300/10 md:bg-transparent flex justify-center md:justify-end items-center md:pr-10 pt-2">
          <a href="https://gyana-ai.vercel.app/" target="_blank" className="z-[1000] inline-flex h-auto p-4 w-auto uppercase text-lg visible animate-shimmer items-center justify-center rounded-xl border-2 border-slate-400 focus:border-slate-200 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-slate-400 hover:text-white transition-colors focus:text-slate-100">
        ...
        <div className="w-full h-full flex flex-col items-center justify-around p-5 overflow-hidden">
          ...
          <div className="md:w-4/5 w-full p-5 flex-row gap-5 bg-stone-300/10 rounded-xl flex">
            <img
              src={Gitwindow}
              alt="GitWindow"
              className="w-full rounded-3xl"
